...
title_zh: 基于LLM的多智能体协作在故障智能体下的鲁棒性研究
...
score: 4.0
evidence: 分析多智能体系统结构及其鲁棒性，与路由拓扑相关
tldr: 多智能体系统中故障智能体如何影响整体性能尚不清楚。本文研究不同系统结构（如链式、全连接）在故障智能体下的鲁棒性，并提出AutoTransform和AutoInject方法模拟故障。实验揭示了结构对鲁棒性的关键影响，为设计可靠的多智能体路由结构提供了指导。
...
motivation: 多智能体系统中故障智能体影响未知，不同结构的鲁棒性缺乏系统研究。
method: 提出AutoTransform和AutoInject方法模拟故障，测试链式、全连接等多种系统结构。
result: 揭示了不同结构对故障的容忍度差异，为设计鲁棒路由拓扑提供依据。
conclusion: 该工作强调了系统结构在多智能体路由中的重要性，并为构建可靠系统提供了建议。
---
