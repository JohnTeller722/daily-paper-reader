...
title_zh: KABB：知识感知贝叶斯强盗用于多智能体系统中的动态专家协调
...
score: 8.0
evidence: 基于知识感知贝叶斯强盗的动态专家协调
tldr: 针对多智能体系统中专家协调效率低和静态知识假设的问题，KABB提出一种知识感知贝叶斯强盗框架，通过自定义知识距离模型实现深层语义理解，结合双适应机制和知识感知汤普森采样策略进行动态专家选择。在多个基准上的评估表明，KABB在保持高性能的同时实现了最优的成本-性能平衡，优于现有方法。
...
motivation: 多智能体系统面临静态知识和协调效率挑战。
method: 提出知识距离模型、双适应机制和知识感知汤普森采样策略。
result: 在多个任务上达到了最优成本-性能平衡。
conclusion: 动态专家协调可显著提升多智能体系统效率。
---
